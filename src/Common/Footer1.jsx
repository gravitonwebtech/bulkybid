    ...
    <>
      <div className="footer-part  p-12 bg-black">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 mx-0 md:mx-12 lg:mx-14 ">
          <div>
            <h4 className="text-[#0071B3] text-3xl font-bold">BULKYBID</h4>
            ...
            <p className="mt-3  text-white">
              Where quality meets affordability.<br/> We understand the importance of<br/>
              a smooth and enjoyable journey<br/> without the burden<br/> of excessive
              costs.
            </p>
          </div>
